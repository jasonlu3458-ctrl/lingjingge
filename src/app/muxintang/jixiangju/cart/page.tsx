...
export default function MuxintangCartPage() {
  ...
  const updateQuantity = (id: string, delta: number) => {
    ...
    localStorage.setItem('muxintang_cart', JSON.stringify(updated));
  };
            ...
            <div className="space-y-4">
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <Link href={`/muxintang/jixiangju/${item.id}`} className="flex-shrink-0">
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-[#242424] border-t border-[#333333] p-4">
              <div className="max-w-4xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <Link
                    href="/muxintang/jixiangju/checkout"
                    className="bg-[#D4AF37] text-[#0a0a0a] px-8 py-3 rounded-lg font-medium hover:bg-[#E5C142] transition-colors"
                  >
                    去结账
                  </Link>
                </div>
