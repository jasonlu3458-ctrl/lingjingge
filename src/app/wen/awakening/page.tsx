...
export default function AwakeningPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      role: 'assistant',
      content: '欢迎来到觉醒日记。这是一个记录内心成长、感悟与反思的空间。请告诉我，你想记录些什么？',
    },
  ]);
  ...
  useEffect(() => {
    const savedConversationId = localStorage.getItem('conv_awakening_uuid');
            ...
            if (line.startsWith('data: ')) {
              try {
                ...
                if (data.conversation_id) {
                  ...
                  localStorage.setItem('conv_awakening_uuid', data.conversation_id);
                }
    ...
    <div className="min-h-screen bg-zen-beige">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-zen-ink mb-2">觉醒日记</h1>
          <p className="text-gray-600">记录内心成长，感悟与反思</p>
        </div>
