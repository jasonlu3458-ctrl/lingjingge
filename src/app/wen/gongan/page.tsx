...
export default function GonganPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      role: 'assistant',
      content: '阿弥陀佛，施主。我是公案参究禅师。请告诉我你想探讨哪个公案，或者提出你的疑问，我将与你一同参究。',
    },
  ]);
  ...
  useEffect(() => {
    const savedConversationId = localStorage.getItem('conv_gongan_uuid');
            ...
            if (line.startsWith('data: ')) {
              try {
                ...
                if (data.conversation_id) {
                  ...
                  localStorage.setItem('conv_gongan_uuid', data.conversation_id);
                }
    ...
    <div className="min-h-screen bg-zen-beige">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-zen-ink mb-2">公案参究</h1>
          <p className="text-gray-600">参究公案，开启智慧</p>
        </div>
