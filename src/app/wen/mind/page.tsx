...
export default function MindPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      role: 'assistant',
      content: '您好，我是 AI 疗愈师。请告诉我您当前的情绪状态和具体情况，我将为您提供专业的情绪疏导和正念疗愈建议。',
    },
  ]);
  ...
  useEffect(() => {
    const savedConversationId = localStorage.getItem('conv_mind_uuid');
            ...
            if (line.startsWith('data: ')) {
              try {
                ...
                if (data.conversation_id) {
                  ...
                  localStorage.setItem('conv_mind_uuid', data.conversation_id);
                }
    ...
    <div className="min-h-screen bg-zen-beige">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-zen-ink mb-2">明心灯·疗愈</h1>
          <p className="text-gray-600">情绪疏导，正念疗愈</p>
        </div>
