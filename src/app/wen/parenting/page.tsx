...
export default function ParentingPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      role: 'assistant',
      content: '您好，我是 AI 亲子导师。请告诉我孩子的年龄和您想咨询的问题，我将为您提供专业的育儿建议和亲子关系指导。',
    },
  ]);
  ...
  useEffect(() => {
    const savedConversationId = localStorage.getItem('conv_parenting_uuid');
            ...
            if (line.startsWith('data: ')) {
              try {
                ...
                if (data.conversation_id) {
                  ...
                  localStorage.setItem('conv_parenting_uuid', data.conversation_id);
                }
    ...
    <div className="min-h-screen bg-zen-beige">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-zen-ink mb-2">AI亲子导师</h1>
          <p className="text-gray-600">探索亲子关系的智慧，陪伴孩子成长</p>
        </div>
