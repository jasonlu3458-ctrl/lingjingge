...
export default function YiliPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      role: 'assistant',
      content: '您好，我是 AI 易理师。请告诉我您想咨询的事项，我将运用易经智慧为您提供决策参考。',
    },
  ]);
  ...
  useEffect(() => {
    const savedConversationId = localStorage.getItem('conv_yili_uuid');
    ...
    <div className="min-h-screen bg-zen-beige">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-zen-ink mb-2">AI易理师</h1>
          <p className="text-gray-600">运用易经智慧，理解生活规律</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="border-t border-zen-gray p-4">
            <div className="flex space-x-4">
              <input
                ...
                placeholder="例如：最近事业不顺，想问问未来发展方向..."
                disabled={isTyping}
