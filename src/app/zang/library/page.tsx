    ...
    <div style={{ minHeight: '100vh', background: '#f5f0eb', padding: '40px 20px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '48px' }}>
          <Link href="/library/terms" style={{ display: 'inline-block', padding: '12px 24px', background: '#ffffff', borderRadius: '8px', border: '1px solid #e8e4e0', textDecoration: 'none', color: '#2c2c2c', fontSize: '14px' }}>
            术语百科
          </Link>
        </div>
      </div>
