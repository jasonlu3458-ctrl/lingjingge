...
interface PetAccessoriesProps {
  tenantId?: string;
  onCheckout?: (items: string[], totalPrice: number) => void;
}
...
export default function PetAccessories({ tenantId = 'muxintang', onCheckout }: PetAccessoriesProps) {
  ...
  const handleCheckout = () => {
    onCheckout?.(Array.from(selectedItems), totalPrice);
  };
